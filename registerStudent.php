<!--
    ...
    This is the student registration page of Assignment 02.
-->
<?php
    ...
    $sql = "INSERT INTO student (firstName,lastName,phone,email,address,postalZip,country,password)
    VALUES ('$firstName','$lastName','$phone','$email','$address','$postalZip','$country','$password')";
    ...
    echo '<html> <head> <Script Language="JavaScript"> alert("Student account registration success. Please log in.");</Script> </head> </html> ' .
