<!--
    ...
    This is the course page for student of Assignment 02.
-->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="keywords" content="course enroll and drop">
            ...
            <ul class="search">
                <li>
                    <div class="search-box">
                        <form action="courseSCH.php" method="post">
                ...
                <table class="SCCL" id="coursestable">
                    ...
                    <?php while ($results = mysqli_fetch_assoc($result_set)) { ?>
                        <tr>
                            ...
                            <td class="courseList"><button onclick="enroll(<?php echo $results['courseID'] . ", " . $studentID; ?>)">Enroll</button></td>
                            <td class="courseList"><button onclick="drop(<?php echo $results['courseID'] . "," . $studentID; ?>)">Drop</button></td>
                        </tr>
                    <?php } ?>
                </table>
            </div>
