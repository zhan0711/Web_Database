<!--
    ...
    This is the login page of Assignment 02.
-->
...
<body onload="time()">
    <main class=picbg>
        ...
        <form name="studentFirst" action="loginTeacher.php" method="post" onsubmit="checkForm()">
            <div class="container">
                <div class="contextItem1">
                    <p>Welcome to the course information management system!</p>
                    <p>This is the <span>teacher</span> login page.</p>
                </div>
                <div class="contextItem2">
                    ...
                    <div class="msg">
                        Don't have account?
                        <a href="2_2_1_teacherSignUp.php">sign up</a>
                    </div>
                </div>
            </div>
        </form>
