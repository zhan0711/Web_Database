<!--
    ...
    This is the drop a course for student page of Assignment 02.
-->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="keywords" content="course drop">
        ...
        <div class="item2HP">
            <?php
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'GET') {
                    $sql = "DELETE FROM grade WHERE (courseID='$courseID' AND studentID='$studentID')";
            ...
            <div class="SPcontent">
                ...
                <div class="pageEdit">
                    ...
                    <p>Successfully drop the course:.</p>
                    <p class="item">
                        <?php
