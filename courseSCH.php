<!--
    ...
    This is the course search result page of Assignment 02.
-->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="keywords" content="student search course">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    if (strlen($courseName) > 0) {
                        ...
                        echo '<html> <head> <Script Language="JavaScript"> alert("Please input valid course name.");</Script> </head> </html> ' .
                            "<meta http-equiv=\"refresh\" content=\"0;url=3_3_course.php\"> ";
                    }
                }
            ?>
            <div class="SPcontent">
